...
BOARD=BPI-M4-720P
board="bpi-m4"
kernel="5.10.11-BPI-M4-Kernel"
headers="linux-headers-5.10.11-BPI-M4-Kernel"
MODE=$1
BPILINUX=linux-rtk
BPIPACK=rtk-pack
BPISOC=rtk
...
R="${SD}/BPI-ROOT"
	...
	cp -a $T/${BPILINUX}/arch/arm64/boot/dts/realtek/rtd1395-bpi-m4.dtb $B/bananapi/${board}/linux/
	#
